...
class _FeedbackScreenState extends State<FeedbackScreen> {
  ...
  final Map<String, IconData> _categoryIcons = {
    ...
    'VARIETY_IDENTIFICATION': Icons.local_florist, // Replaced Icons.leaf with Icons.local_florist
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Icon(Icons.message, color: Colors.green[600], size: 32),
                    ...
                    children: List.generate(5, (index) {
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: _rating > index ? Colors.amber[100] : Colors.grey[100],
                            borderRadius: BorderRadius.circular(12),
                            boxShadow: [
                              if (_rating > index)
                                BoxShadow(
                          ...
                          child: Icon(
                            Icons.star,
                            color: _rating > index ? Colors.amber[600] : Colors.grey[400],
                            size: 32,
                          ),
                        ),
                      );
                  ...
                  Row(
                    children: [
                      Icon(Icons.arrow_drop_down, color: Colors.green[600], size: 20),
                      const SizedBox(width: 8),
                      Text(
                        'Category',
                        style: TextStyle(
                  ...
                  TextField(
                    ...
                    maxLines: 6,
                    decoration: InputDecoration(
                      hintText: 'Tell us what you think... What worked well? What can we improve?',
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                        borderSide: BorderSide(color: Colors.grey[300]!),
                      ),
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: _isLoading || _rating == 0
                          ? Colors.grey[400]
                          : null,
